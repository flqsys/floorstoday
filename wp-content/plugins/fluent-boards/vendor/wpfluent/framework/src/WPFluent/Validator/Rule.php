...
use FluentBoards\Framework\Validator\Rules\In;
use FluentBoards\Framework\Validator\Rules\NotIn;
use FluentBoards\Framework\Validator\Rules\Unique;
use FluentBoards\Framework\Validator\Rules\Exists;
use FluentBoards\Framework\Validator\Rules\RequiredIf;
use FluentBoards\Framework\Validator\Rules\Dimensions;
use FluentBoards\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \FluentBoards\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \FluentBoards\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentBoards\Framework\Validator\Rules\Exists
     */
     ...
     *
     * @param  \FluentBoards\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentBoards\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \FluentBoards\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentBoards\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \FluentBoards\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentBoards\Framework\Validator\Rules\Unique
     */
