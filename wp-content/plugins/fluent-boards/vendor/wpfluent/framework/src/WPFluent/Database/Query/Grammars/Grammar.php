...
namespace FluentBoards\Framework\Database\Query\Grammars;

use RuntimeException;
use FluentBoards\Framework\Support\Arr;
use FluentBoards\Framework\Support\Helper;
use FluentBoards\Framework\Database\BaseGrammar;
use FluentBoards\Framework\Database\Query\Builder;
use FluentBoards\Framework\Database\Query\Expression;
use FluentBoards\Framework\Database\Query\JoinClause;
use FluentBoards\Framework\Database\Query\JoinLateralClause;
use FluentBoards\Framework\Database\Concerns\CompilesJsonPaths;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \FluentBoards\Framework\Database\Query\JoinLateralClause  $join
