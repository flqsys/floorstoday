...
trait QueriesRelationships
{
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Relations\Relation|string  $relation
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Relations\MorphTo|string  $relation
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Relations\MorphTo  $relation
     * @param  string  $type
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Relations\MorphTo|string  $relation
     * @param  \FluentBoards\Framework\Database\Orm\Model|string  $model
     * @return \FluentBoards\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Model  $related
     ...
     *
     * @param  string  $column
     * @param  \FluentBoards\Framework\Database\Orm\Relations\Relation<*, *, *>  $relation
     * @return string
     */
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Builder  $hasQuery
     * @param  \FluentBoards\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Builder  $from
     * @return \FluentBoards\Framework\Database\Orm\Builder|static
     */
