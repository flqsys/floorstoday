...
use FluentBoards\Framework\Database\Orm\RelationNotFoundException;
use FluentBoards\Framework\Database\Orm\Concerns\QueriesRelationships;
...
class Builder
{
     ...
     *
     * @var \FluentBoards\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentBoards\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \FluentBoards\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \FluentBoards\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentBoards\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     *
     * @param  \Closure|string|array|\FluentBoards\Framework\Database\Query\Expression  $column
     ...
     *
     * @param  \Closure|array|string|\FluentBoards\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentBoards\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentBoards\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \FluentBoards\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentBoards\Framework\Database\Orm\Model|\FluentBoards\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  \FluentBoards\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentBoards\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentBoards\Framework\Database\Orm\Model|\FluentBoards\Framework\Database\Orm\Collection|static|static[]
     *
     ...
     * @return \FluentBoards\Framework\Database\Orm\Model
     *
     * @throws \FluentBoards\Framework\Database\Orm\ModelNotFoundException
     * @throws \FluentBoards\Framework\Database\MultipleRecordsFoundException
     */
     ...
     * @return mixed
     *
     * @throws \FluentBoards\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentBoards\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \FluentBoards\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentBoards\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \FluentBoards\Framework\Pagination\LengthAwarePaginator
     *
     ...
     *
     * @param  array  $attributes
     * @return \FluentBoards\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  array|\FluentBoards\Framework\Database\Query\Expression  $columns
     * @return array
     */
