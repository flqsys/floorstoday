...
final class WOOF_META_FILTER extends WOOF_EXT {
	...
	public function woof_meta_get_keys() {
		...
		if ( ! isset( $_POST['meta_nonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['meta_nonce'] ) ), 'woof_get_meta_keys' ) ) {
			die();
		}
	...
	public function woof_print_html_type_options_meta() {
		// old
		$key = '';
