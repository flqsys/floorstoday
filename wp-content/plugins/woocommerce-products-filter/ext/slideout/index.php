...
final class WOOF_SLIDEOUT extends WOOF_EXT {
	...
	public function init() {
		...
		$this->options = array(
			'slideout_img' => array(
				...
				'placeholder' => esc_html__( 'Select image', 'woocommerce-products-filter' ),
				'description' => '',
			),
		);
	}
	...
	public function wp_footer() {
		...
		wp_enqueue_style( 'woof-slideout-tab-css', $this->get_ext_link() . 'css/jquery.tabSlideOut.css', array(), WOOF_VERSION );
		wp_enqueue_style( 'woof-slideout-css', $this->get_ext_link() . 'css/slideout.css', array(), WOOF_VERSION );
