	...
	public function show_alert() {
		...
		if ( $show ) {
			if ( isset( $_GET['tab'] ) and $_GET['tab'] == 'woof' ) {
				...
				<?php // Inline script is required: contains a dynamic nonce value (wp_create_nonce) that must be generated server-side and passed to JS for the AJAX request. ?>
				<script>
