...
namespace FluentPdf\Vendor\Mpdf\PsrHttpMessageShim;

use FluentPdf\Vendor\Psr\Http\Message\StreamInterface;
use FluentPdf\Vendor\Psr\Http\Message\ResponseInterface;
use FluentPdf\Vendor\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \FluentPdf\Vendor\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \FluentPdf\Vendor\Psr\Http\Message\StreamInterface */
	private $stream;
