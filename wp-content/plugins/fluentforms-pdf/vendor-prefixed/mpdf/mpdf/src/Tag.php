...
class Tag
{
	...
	/**
	 * @param \FluentPdf\Vendor\Mpdf\Mpdf $mpdf
	 * @param \FluentPdf\Vendor\Mpdf\Cache $cache
	 * @param \FluentPdf\Vendor\Mpdf\CssManager $cssManager
	 * @param \FluentPdf\Vendor\Mpdf\Form $form
	 * @param \FluentPdf\Vendor\Mpdf\Otl $otl
	 * @param \FluentPdf\Vendor\Mpdf\TableOfContents $tableOfContents
	 * @param \FluentPdf\Vendor\Mpdf\SizeConverter $sizeConverter
	 * @param \FluentPdf\Vendor\Mpdf\Color\ColorConverter $colorConverter
	 * @param \FluentPdf\Vendor\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \FluentPdf\Vendor\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'FluentPdf\Vendor\Mpdf\Tag\\';
