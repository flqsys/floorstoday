...
### Lates changes
We ahve remove all plugins that delaing with forms and created react form and home page connected to the wordpress...
Header is react header not elementor header, we need to creat an shortcode for header and foorter