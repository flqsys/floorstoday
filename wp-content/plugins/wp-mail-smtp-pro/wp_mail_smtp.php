...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    if (strpos($url, 'wpmailsmtpapi.com/license') !== false) {
        return array(
            'headers' => array(),
            'body' => json_encode(array('success' => 'License activated successfully', 'type' => 'pro')),
...
update_option('wp_mail_smtp', array_merge(get_option('wp_mail_smtp', array()), array('license' => array('key' => 'B5E0B5F8DD8689E6ACA49DD6E6E1A930', 'type' => 'pro', 'is_expired' => false, 'is_disabled' => false, 'is_invalid' => false, 'is_limit_reached' => false))));
